...
Monkey C **watch app** that tracks meditation time and heart rate, then syncs sessions to your backend (same API key as [GarminReadingApp](https://github.com/your-org/GarminReadingApp)).
